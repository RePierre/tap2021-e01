...
namespace evaluare
{
    class Room
    {
        ...
        Room() { id = 0; floor = 0;price = 0;tenants = 0;nice_view = false; }
        Room(int room_number, int floor_level, int price_for_room, int numer_of_tenants, bool room_nice_view)
        {
            id = room_number;
            floor= floor_level;
